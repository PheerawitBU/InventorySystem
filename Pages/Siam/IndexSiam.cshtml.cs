...
namespace InventorySystem.Pages.Siam
{
    public class IndexSiamModel : PageModel
    {
        ...
        public void OnGet()
        {
            try
            {
                String connectionString = "Server=tcp:inventorypheerawitbu.database.windows.net,1433;Initial Catalog=inventory;Persist Security Info=False;User ID=pheerawit;Password=Kim12345;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
